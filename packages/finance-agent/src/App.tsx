      ...
      <div style={{ maxWidth: 480, width: "100%" }}>
        ...
        <select
          ...
          style={{
            ...
            borderRadius: 6, border: "1px solid #ccc", fontSize: 14, background: "#fff",
          }}
        >
          {PROVIDERS.map((p) => (
  ...
  return (
    <div
      ...
      style={{
        ...
        fontSize: 13, position: "relative", flexShrink: 0,
      }}
    >
      {menus.map((menu, mi) => (
        <div key={mi} style={{ position: "relative" }}>
          <div
            ...
            style={{
              ...
              background: openMenu === mi ? "#e0e0e0" : "transparent", marginLeft: 2,
            }}
          >
            {menu.label}
          </div>
          {openMenu === mi && (
            <div
              style={{
                ...
                boxShadow: "0 4px 12px rgba(0,0,0,0.1)", padding: "4px 0", zIndex: 50,
              }}
            >
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px 16px 8px" }}>
        {messages.length === 0 && !loading && (
          <p style={{ color: "#bbb", textAlign: "center", marginTop: 80, fontSize: 14 }}>
  ...
  if (page === "loading") {
    return (
      <div style={{
        ...
        height: "100vh", color: "#999", fontFamily: "system-ui, -apple-system, sans-serif",
      }}>
        Loading…
      </div>
    );
